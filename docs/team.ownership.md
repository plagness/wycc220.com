...
| Telegram Bot            | `apps/telegram.bot`, `docs/telegram.bot.md` | Bot API, channel/chat/private modules              |
...
После появления организации: `web`, `ui`, `api`, `games`, `media`, `collectors`, `telegram-bot`, `activity`, `gallery`, `platform`, `security`, `moderators`. До этого CODEOWNERS указывает текущего мейнтейнера и содержит готовую карту для будущей замены на team handles.
